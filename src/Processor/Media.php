...
use Blupl\Franchises\Model\MediaOrganization as Eloquent;
use Orchestra\Contracts\Foundation\Foundation;
use Blupl\Franchises\Http\Presenters\MediaPresenter as MediaPresenter;
use Blupl\Franchises\Validation\Media as MediaValidator;
...
class Media extends Processor
{
    ...
    public function __construct(MediaPresenter $presenter, MediaValidator $validator, Foundation $foundation)
    {
        ...
        $this->model = $foundation->make('Blupl\Franchises\Model\MediaOrganization');
